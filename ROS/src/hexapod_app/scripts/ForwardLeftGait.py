...
class ForwardLeftGait (Gait):
    ...
    def update(self, robot):
        ...
        robot.left_front.set_leg_pos( -self.horiz_angle / 4, -self.vert_angle)
        robot.left_mid.set_leg_pos( self.horiz_angle / 4, self.vert_angle)
        robot.left_back.set_leg_pos( -self.horiz_angle / 4, -self.vert_angle)
