...
class ForwardRightGait (Gait):
    ...
    def update(self, robot):
        ...
        robot.right_front.set_leg_pos( self.horiz_angle / 4, self.vert_angle)
        robot.right_mid.set_leg_pos( -self.horiz_angle / 4, -self.vert_angle)
        robot.right_back.set_leg_pos( self.horiz_angle / 4, self.vert_angle)
